...
export const Navigation = (): JSX.Element => {
  ...
  return (
    <div className="wrapper fixed navigation">
      <nav className="relative flex items-center justify-between bg-white px-4 py-4">
        <a className="text-3xl font-bold leading-none" href="#">
          <img src="/images/logo.png" alt="NOIND logo" width={150} />
        </a>
        ...
        <ul className="hidden lg:flex lg:flex lg:w-auto lg:items-center lg:space-x-8">
          <li>
            <a className="font-serif text-md text-violet-900 hover:text-violet-500" href="#working-with">
              Werken met NOIND
            </a>
          </li>
          <li>
            <a className="font-serif text-md text-violet-900 hover:text-violet-500" href="#">
              Onze visie
            </a>
          </li>
          <li>
          ...
          <li className="text-gray-300">
            <svg width="2px" height="30px" viewBox="0 0 2 40" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Navigation" transform="translate(-1229.000000, -35.000000)" stroke="#ECECEC">
                  <line x1="1229.65707" y1="35.5" x2="1229.65707" y2="74.0917544" id="Path-2"></line>
                </g>
              </g>
            </svg>
          </li>
          <li>
            <a
              className="hidden rounded-xl bg-orange-400 px-6 py-2 text-sm font-serif text-md text-white transition hover:bg-orange-500 lg:inline-block"
              href="#demo"
            >
              Book Demo
            </a>
